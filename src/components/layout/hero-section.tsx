    ...
    <div id="hero" className="mt-20 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container px-4  pt-8 pb-12 mx-auto text-center">
        ...
        <motion.h1
          ...
          className="max-w-3xl mx-auto text-4xl md:text-6xl lg:text-7xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70"
        >
          Specialist in{" "}
