    ...
    <>
      <div id="hero" className="mt-20 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container px-4  pt-8 pb-12 mx-auto text-center">
          ...
          >
            Met onze hoogwaardige isolatieoplossingen en vakkundige installatie helpen we huiseigenaren in de randstad hun energierekening te verlagen en wooncomfort te verhogen
          </motion.p>
